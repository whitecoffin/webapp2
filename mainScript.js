...
function SelectKosenjoh() {
    // すべての親となるdivを取得
    var selectAndGenKosenjoh = document.getElementById("selectAndGenKosenjoh");
    ...
    calcBtn.setAttribute("class", "blueBtn");
    calcBtn.setAttribute("onclick", "CalcAndDisp();");
    calcBtn.textContent = "時速を計算する";
    selectAndGenKosenjoh.appendChild(calcBtn);
